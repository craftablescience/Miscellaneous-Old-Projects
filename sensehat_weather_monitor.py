# Created by Brendan Lewis
# Once it loads, it logs data to data.txt every 30 seconds
# Click the Sense HAT and press Return / Enter to shut off
...
loading_icn(2, sense)
sense.show_message("Weather Monitor", scroll_speed = 0.05)
